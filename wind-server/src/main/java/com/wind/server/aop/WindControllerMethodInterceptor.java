...
public record WindControllerMethodInterceptor(ScriptAuditLogRecorder auditLogRecorder, MethodParameterInjector methodParameterInjector) implements MethodInterceptor {
    ...
    public Object invoke(@Nonnull MethodInvocation invocation) throws Throwable {
        ...
        try {
            String idempotentKey = request == null ? null : request.getHeader(HTTP_REQUEST_IDEMPOTENT_HEADER_NAME);
            ...
            if (request != null) {
                request.setAttribute(WindHttpConstants.getRequestExceptionLogOutputMarkerAttributeName(th), true);
            }
